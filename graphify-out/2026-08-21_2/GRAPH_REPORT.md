...
## Corpus Check
- 191 files · ~1,355,097 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 994 nodes · 1221 edges · 193 communities (119 shown, 74 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 251 edges (avg confidence: 0.86)
...
- [[_COMMUNITY_Mission Request Controller & Code Generator|Mission Request Controller & Code Generator]]
...
- [[_COMMUNITY_Transport Protected-Record Safeguard|Transport Protected-Record Safeguard]]
- [[_COMMUNITY_Place CRUD Icon Set|Place CRUD Icon Set]]
...
- [[_COMMUNITY_MissionRequest Model Display Methods|MissionRequest Model Display Methods]]
- [[_COMMUNITY_Mission Request Authorization Policy|Mission Request Authorization Policy]]
- [[_COMMUNITY_Stimulus Controllers (incl. Mode Switch)|Stimulus Controllers (incl. Mode Switch)]]
...
- [[_COMMUNITY_Transport CRUD Icon Set|Transport CRUD Icon Set]]
- [[_COMMUNITY_Project Branding & License|Project Branding & License]]
- [[_COMMUNITY_Claude Code Workflow Guidance|Claude Code Workflow Guidance]]
- [[_COMMUNITY_README Stack Tecnico|README Stack Tecnico]]
- [[_COMMUNITY_Rails ServerCableDB Config|Rails Server/Cable/DB Config]]
- [[_COMMUNITY_Environment Config (StorageDevTest)|Environment Config (Storage/Dev/Test)]]
- [[_COMMUNITY_Add Validator Fields Migration|Add Validator Fields Migration]]
- [[_COMMUNITY_Create Vehicles Migration|Create Vehicles Migration]]
- [[_COMMUNITY_Create Transports Migration|Create Transports Migration]]
- [[_COMMUNITY_Devise Create Users Migration|Devise Create Users Migration]]
- [[_COMMUNITY_Add User Signature Migration|Add User Signature Migration]]
- [[_COMMUNITY_Add Confirmator Fields Migration|Add Confirmator Fields Migration]]
...
- [[_COMMUNITY_Bilingual License & README|Bilingual License & README]]
...
- [[_COMMUNITY_Mission Request Dashboard|Mission Request Dashboard]]
...
3. `PlacesController` - 15 edges
4. `MissionRequest` - 13 edges
5. `ApplicationPolicy#admin?` - 13 edges
6. `MissionRequestsController` - 12 edges
7. `Reason` - 11 edges
8. `ReimbursementsController` - 11 edges
9. `PathsController` - 11 edges
10. `PlacesController` - 11 edges

## Surprising Connections (you probably didn't know these)
- `README Terminus Overview (IT/EN)` --semantically_similar_to--> `Terminus (applicazione)`  [INFERRED] [semantically similar]
  README.md → CLAUDE.md
- `IT locale: place` --references--> `Place`  [EXTRACTED]
  config/locales/it.yml → app/models/place.rb
- `IT locale: path` --references--> `Path`  [EXTRACTED]
  config/locales/it.yml → app/models/path.rb
- `IT locale: user` --references--> `User`  [EXTRACTED]
...
Cohesion: 0.10
Nodes (8): ApplicationController#user_not_authorized, ApplicationPolicy#admin?, ApplicationPolicy, Scope, MissionRequestPolicy, Scope, ReimbursementPolicy, Scope
...
Cohesion: 0.17
Nodes (3): MissionRequestsController, MissionRequestsController, MissionRequestCodeGenerator
...
### Community 15 - "Stimulus JS Controllers"
Cohesion: 0.33
...
Cohesion: 0.07
Nodes (11): Admin::ApplicationController#authenticate_admin, db/seeds.rb admin user seed, :user FactoryBot factory, IT locale: user, MissionRequestMailer, MissionRequest, User model spec, User (+3 more)
...
### Community 22 - "MissionRequest Model Display Methods"
Cohesion: 0.29
...
### Community 23 - "Mission Request Authorization Policy"
Cohesion: 0.29
...
### Community 24 - "Stimulus Controllers (incl. Mode Switch)"
Cohesion: 0.06
...
### Community 30 - "ApplicationController Base Actions"
Cohesion: 1.00
...
Cohesion: 0.21
Nodes (3): MissionRequestValidationsController, Scope, ValidatorMissionRequestPolicy
...
- **What is the exact relationship between `Database Config` and `Action Cable Config`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `User` connect `Transport Protected-Record Safeguard` to `Admin Panel: Transports & Vehicles`, `Application Auth Base`, `Dev/Build Scripts`, `Reasons/Structures Controllers CRUD`, `Community 168`, `Mission Request Controller & Code Generator`, `Path/Structure Authorization Policies`, `Paths Controller CRUD`, `Community 125`, `Community 127`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `MissionRequestsController` connect `Path/Place/Reason/Structure Test Suite` to `Transport Protected-Record Safeguard`?**
