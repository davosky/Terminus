...
RSpec.describe "Director::MissionRequests (da approvare)", type: :request do
  ...
  describe "GET /director/mission_requests/pending" do
    it "mostra al validatore competente le richieste da approvare" do
      sign_in matching_manager

      get pending_director_mission_requests_path
  ...
  describe "PATCH /director/mission_requests/:id/reject" do
    it "respinge la richiesta con il motivo indicato" do
      ...
      patch reject_director_mission_request_path(pending_request), params: { rejection_motivation: "Dati incompleti" }
    ...
    it "non respinge senza motivo e torna all'elenco con un avviso" do
      ...
      patch reject_director_mission_request_path(pending_request), params: { rejection_motivation: "" }, headers: { "HTTP_REFERER" => pending_director_mission_requests_url }

      expect(response).to redirect_to(pending_director_mission_requests_path)
